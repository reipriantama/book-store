...
const DetailBlog = () => {
  return (
    ...
    >
      <div className=''>
        <img
          src={`${process.env.PUBLIC_URL}/assets/detailBlog/section1/imageBlog1.png`}
          alt='img'
        ...
        <div className='text-[19px] text-thin-grey mb-[44px]'>
          ...
          the majorithave suffered alteration in some form, by injected humour,
          or randomised words whicdon't look even slightly believable. If you
          are going to use a passage of Lorem Ipsum, need to be sure there isn't
          anything embarrassing hidden in the middle of text. All thLorem Ipsum
        ...
        <div className='text-[19px] text-thin-grey mb-[22px]'>
          ...
          using Lorem Ipsum is that it has less normal distribution of letters,
          as opposed.
        </div>
